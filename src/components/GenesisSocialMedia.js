    ...
    >
      ...
      >
        ...
        <Card sx={cardStyle(twoColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 1.jpg" sx={imageStyle} />
        </Card>
        <Card sx={cardStyle(twoColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 5.jpg" sx={imageStyle} />
        </Card>

        {/* Row 2: 3 images */}
        <Card sx={cardStyle(threeColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 3.jpg" sx={imageStyle} />
        </Card>
        <Card sx={cardStyle(threeColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 4.jpg" sx={imageStyle} />
        </Card>
        <Card sx={cardStyle(threeColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 2.jpg" sx={imageStyle} />
        </Card>

        {/* Row 3: 2 images */}
        <Card sx={cardStyle(twoColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 6.jpg" sx={imageStyle} />
        </Card>
        <Card sx={cardStyle(twoColumnWidth)}>
          <CardMedia component="img" image="/images/genesis/genesis 7.jpg" sx={imageStyle} />
        </Card>
      </Box>
    </Box>
  );
